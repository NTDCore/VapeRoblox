...
local function GetURL(scripturl)
	if shared.VapeDeveloper then
		...
		return game:HttpGet("https://raw.githubusercontent.com/NTDCore/VapeV4ForRoblox/main/"..scripturl, true)
	end
end
			...
			if callback then
				...
				if not suc then
					...
					framebutton1.MouseButton1Click:connect(function()
						spawn(function()
							setclipboard("https://github.com/NTDCore/VapeV4ForRoblox/wiki/Turning-on-Highlights")
